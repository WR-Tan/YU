...
#warning 这里应该加一个AppIcon
    ...
    imageView.center = CGPointMake(kScreenWidth / 2, 72 / 2 + 50);
    imageView.image = [UIImage imageNamed:@"yuxiuIcon"];
