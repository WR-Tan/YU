//
//  BSNearbyBadmintonHallController.m
//  BadmintonShow
//
...
#import "BSNearbyHallCell.h"

@interface BSNearbyBadmintonHallController ()<UICollectionViewDelegate,UICollectionViewDataSource>
{
...
@implementation BSNearbyBadmintonHallController
...
- (void)addCollectionView
{
    ...
    //注册Cell，必须要有
    [_collectionView registerNib:[UINib nibWithNibName:@"BSNearbyHallCell" bundle:nil] forCellWithReuseIdentifier:@"BSNearbyHallCell"];
...
{
    static NSString * CellIdentifier = @"BSNearbyHallCell";
    BSNearbyHallCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifier forIndexPath:indexPath];
