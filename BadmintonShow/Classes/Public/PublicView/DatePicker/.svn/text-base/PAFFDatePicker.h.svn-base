...
//  说明，PAFFDatePicker的Size最小是320x216的。
@protocol PAFFDatePickerDelegate <NSObject>

- (void)datePicker:(PAFFDatePicker *)datePicker
                year:(NSString *)year
...
@interface PAFFDatePicker : PAFFCustomModalView<UIPickerViewDelegate,UIPickerViewDataSource>

@property (nonatomic, copy) FinishBlock finishBlock;

@property (nonatomic, assign) id <PAFFDatePickerDelegate> delegate1;
